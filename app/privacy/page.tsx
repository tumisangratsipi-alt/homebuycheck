...
export const metadata: Metadata = {
  title: "Privacy Policy — homebuycheck.com",
  description: "Privacy policy for homebuycheck.com. We don't store your financial data.",
  alternates: { canonical: "https://homebuycheck.com/privacy" },
};
    ...
    <main className="max-w-2xl mx-auto px-4 py-16" style={{ color: "var(--text-secondary)" }}>
      ...
      <section className="mb-8">
        ...
        <p className="leading-relaxed mb-3">
          <strong>Nothing you type into the calculator is stored.</strong> All affordability
          calculations run entirely in your browser. No income figures, debt amounts, or any
      ...
      <section className="mb-8">
        ...
        <p className="leading-relaxed">
          ...
          <a href="mailto:privacy@homebuycheck.com" style={{ color: "var(--amber-500)" }}>
            privacy@homebuycheck.com
          </a>
        </p>
      </section>
    </main>
